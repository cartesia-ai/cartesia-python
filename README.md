...
[httpx](https://github.com/encode/httpx), as well as websockets support powered
by [websockets](https://websockets.readthedocs.io/en/stable/).
...
response = client.tts.generate(
    ...
    transcript="Hi there! This audio is generated by Sonic: Cartesia's real-time text-to-speech model.",
    voice={
        "mode": "id",
        "id": "e07c00bc-4134-4eae-9ea4-1a55fb45746b",
    },
)
response.write_to_file("cartesia_generated.wav")
```

## Streaming inputs with Websockets

Stream in a transcript split into multiple parts.  Useful for streaming
transcripts generated by an LLM for latency-sensitive applications such as voice
agents.
...
async def main() -> None:
    ...
    await response.write_to_file("cartesia_generated.wav")
...
We have extensive examples in examples/examples.py (and
examples/async_examples.py), including:

- [`tts_generate_to_file`](https://github.com/cartesia-ai/cartesia-python/blob/main/examples/examples.py#L32): generate text-to-speech audio and save it to a file.
- [`tts_websocket_basic`](https://github.com/cartesia-ai/cartesia-python/blob/main/examples/examples.py#L199):
  connect to Cartesia over websockets and generate text-to-speech audio
- [`tts_websocket_continuations`](https://github.com/cartesia-ai/cartesia-python/blob/main/examples/examples.py#L226):
  stream transcripts to Cartesia over websockets. This is useful when your text
  is generated by an LLM's streaming API.
- [`tts_async_concurrent_contexts`](https://github.com/cartesia-ai/cartesia-python/blob/main/examples/async_examples.py#L291):
  multiple concurrently-generated text-to-speech audios streamed over a single
  websocket. This is the most performant way to integrate Cartesia at scale.
...
- [cartesia-js](http://github.com/cartesia-ai/cartesia-js), the Javascript SDK
  for our inference API
- [line](http://github.com/cartesia-ai/line), our Voice Agents SDK
- [edge](http://github.com/cartesia-ai/edge), on-device intelligence

...
- `tts_generate_to_file`: generate text-to-speech audio and save it to a file.
- `tts_websocket_basic`: connect to Cartesia over websockets
- `tts_websocket_continuations`: stream transcripts (eg, as generated by an LLM) to Cartesia over websockets.

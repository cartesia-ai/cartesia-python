...
We recommend using [`python-dotenv`](https://pypi.org/project/python-dotenv/) to add `CARTESIA_API_KEY="my-api-key"` to your .env file. You can also get the key from the client's enviornment variables. Do not store your API Key in the source code.

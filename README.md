...
- [`tts_generate_to_file`](/examples/examples.py#L34): generate text-to-speech audio and save it to a file.
- [`tts_websocket_basic`](/examples/examples.py#L212):
  connect to Cartesia over websockets and generate text-to-speech audio
- [`tts_websocket_continuations`](/examples/examples.py#L241):
  stream transcripts to Cartesia over websockets. This is useful when your text
  is generated by an LLM's streaming API.
- [`tts_async_concurrent_contexts`](/examples/async_examples.py#L352):
...
We automatically send the `cartesia-version` header set to `2026-08-14`.

...
The 3.x series of this library maintains backwards compatibility with the method
signatures from the 2.x version. To use the latest helpers, see MIGRATING.md.

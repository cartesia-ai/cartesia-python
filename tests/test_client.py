...
class TestCartesia:
    ...
    def test_hardcoded_query_params_in_url(self, client: Cartesia) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Cartesia) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Cartesia) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
...
class TestAsyncCartesia:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncCartesia) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncCartesia) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)

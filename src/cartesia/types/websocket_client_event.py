...
__all__ = ["WebsocketClientEvent", "GenerationRequest", "GenerationRequestOutputFormat", "CancelContextRequest"]


class GenerationRequestOutputFormat(BaseModel):
...
class GenerationRequest(BaseModel):
    ...
    output_format: GenerationRequestOutputFormat

...
class DatasetsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/datasets/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=Dataset,
    ...
    def list(
        ...
        *,
        ...
        `ending_before` is a Dataset ID that defines your
          ...
          limit: The number of Datasets to return per page, ranging between 1 and 100.

          starting_after: A cursor to use in pagination. `starting_after` is a Dataset ID that defines
...
class DatasetsResourceWithRawResponse:
    ...
    def files(self) -> FilesResourceWithRawResponse:
        return FilesResourceWithRawResponse(self._datasets.files)
...
class AsyncDatasetsResourceWithRawResponse:
    ...
    def files(self) -> AsyncFilesResourceWithRawResponse:
        return AsyncFilesResourceWithRawResponse(self._datasets.files)
...
class DatasetsResourceWithStreamingResponse:
    ...
    def files(self) -> FilesResourceWithStreamingResponse:
        return FilesResourceWithStreamingResponse(self._datasets.files)
...
class AsyncDatasetsResourceWithStreamingResponse:
    ...
    def files(self) -> AsyncFilesResourceWithStreamingResponse:
        return AsyncFilesResourceWithStreamingResponse(self._datasets.files)

...
class FilesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        Args:
          ending_before: A cursor to use in pagination. `ending_before` is a file ID that defines your
          ...
          limit: The number of files to return per page, ranging between 1 and 100.

          starting_after: A cursor to use in pagination. `starting_after` is a file ID that defines your
              place in the list. For example, if you make a dataset files request and receive
    ...
    def upload(
        ...
        *,
        ...
        Args:
          purpose: Purpose of the file (e.g., fine_tune)
